...
public class ES93TSDBDefaultCompressionLucene103Codec extends FilterCodec {
    ...
    public ES93TSDBDefaultCompressionLucene103Codec(Lucene103Codec delegate, BigArrays bigArrays) {
        super("ES93TSDBDefaultCompressionLucene103Codec", new TSDBSyntheticIdCodec(delegate));
