...
public class TSDBStoredFieldsFormat extends StoredFieldsFormat {
    ...
    class PerFieldStoredFieldsWriter extends StoredFieldsWriter {
        ...
        PerFieldStoredFieldsWriter(Directory directory, SegmentInfo si, IOContext context) throws IOException {
    ...
    public class PerFieldStoredFieldsReader extends StoredFieldsReader {
        ...
        PerFieldStoredFieldsReader(StoredFieldsReader storedFieldsReader, StoredFieldsReader bloomFilterStoredFieldsReader) {
        ...
        public StoredFieldsReader clone() {
            return new PerFieldStoredFieldsReader(storedFieldsReader.clone(), bloomFilterStoredFieldsReader.clone());
        }

        @Override
        public StoredFieldsReader getMergeInstance() {
            return new PerFieldStoredFieldsReader(storedFieldsReader.getMergeInstance(), bloomFilterStoredFieldsReader.getMergeInstance());
        }
        ...
        @Nullable
        public StoredFieldsReader getIdBloomFilterReader() {

            return bloomFilterStoredFieldsReader;
        }
    }
}
